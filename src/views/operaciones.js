...
class viewOperaciones extends Component {
    ...
    peticionGet = async () => {
        axios.get(URL + 'operaciones').then(response => {
    ...
    peticionPost  = async () => {      
        ...
        for (let i = 1; i < ArrayD.value.length-1; i++) {
            ...
            await axios.post(URL + 'operaciones', this.state.form).then(response => {                
            }).catch(error => {
                console.log(error.message);
            })
        }
        ...
        return (
            <div className="App">
                ...
                <div className="containerCuatro">
                    <button className="btn btn-success" onClick={() => { this.setState({ form: null, tipoModal: 'insertar' }); this.modalInsertar() }}> <AddBox icon={tableIcons.Add} /> Agregar Operaciones</button>
                </div>
                ...
                <Modal isOpen={this.state.modalInsertar}>
                    ...
                    <ModalBody>
                        <div className="form-group">
                            ...
                            <label htmlFor="nombre">Adjunte el archivo de operaciones (.csv)</label>
