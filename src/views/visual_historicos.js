...
class viewVisualHistorico extends React.Component {
    ...
    cambioNombre=(campo)=> {  
        var respuesta = campo;
        switch (campo) {
            case 'operacion_0': respuesta = 'Undef status'; break; 
            case 'operacion_2': respuesta = 'Drilling'; break;
            case 'operacion_3': respuesta = 'Connection'; break;
            case 'operacion_4': respuesta = 'Reaming'; break;
            case 'operacion_7': respuesta = 'Circulating'; break;
            case 'operacion_8': respuesta = 'RIH'; break;
            case 'operacion_9': respuesta = 'POOH'; break;
            case 'operacion_35': respuesta = 'OnSurface'; break;
            case 'operacion_36': respuesta = 'Sliding'; break;
            case 'operacion_37': respuesta = 'POOHW/Pump'; break;
            case 'operacion_38': respuesta = 'RIHW/Pump'; break;
            case 'operacion_39': respuesta = 'BackReaming'; break;
            case 'operacion_40': respuesta = 'Working Pipe'; break;
            case 'operacion_41': respuesta = 'Unregister'; break;
        }
        return respuesta;
    }
    ...
    peticionWellsGet = () => {
        axios.get(urlAuxiliar+'?g').then(response => {
            ...
            .then(
                (result) => {
                    ...
                    for (let k = 0; k < datosregistro.length; k++) {
                        ...
                        datosgrafHorizont_DBTM_Aux = ''; ejex = '';
                   ...
                   // datosProfundidad = datosProfundidad.valueOf();
                    ...
                    for (let j =1; j < matriz.length; j++) {
                        ...
                        if (matriz[j].clave === 'idWell' || matriz[j].clave === 'idWellbore' || matriz[j].clave === 'idLogCurve' || matriz[j].clave === 'DATETIME') { }
                        else if (matriz[j].clave === 'DMEA' || matriz[j].clave === 'MFIA' || matriz[j].clave === 'RPM' || matriz[j].clave === 'TQA' || matriz[j].clave === 'DBTM' || matriz[j].clave === 'puntero_vertical') {
                            console.log(matriz[j].clave);
                            switch (matriz[j].clave) {
                                case 'DBTM':
                                    // Aqui se arma la trama de la grafica Horizontal (tiempo)-------------------
                                    datosgrafHorizont_DBTM_Aux = '{ x: [' + datosDateTime + '],  y: [' + matriz[j].valor.replace('"', '') + '], mode:"lines+markers", type:"scatter", name:"' + matriz[j].clave.replace('_', ' ') + '", text:"' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x", yaxis: "y" },';
                                 ...
                                 //   datosgrafVertical_DBTM_Aux = '{ x: [' + matriz[j].valor.replace('"', '') + '], y: [' + datosProfundidad + '], mode: "lines+markers",  type: "scatter",  name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '",  xaxis: "x", yaxis: "y"}';
                                    ...
                                    datosGraficaPrincipal_Aux = datosGraficaPrincipal_Aux + '{ x: [' + datosDateTime + '],  y: [' + matriz[j].valor.replace('"', '') + '], mode: "lines+markers",  type: "scatter",  name: "' + matriz[j].clave.replace('_', ' ') + '" },';
                                    break;

                                case 'DMEA':
                                    // Aqui se arma la trama de la grafica Horizontal (tiempo)-------------------
                                    datosgrafHorizont_DMEA_Aux = '{ x: [' + datosDateTime + '], y: [' + matriz[j].valor.replace('"', '') + '], mode: "lines+markers",  type: "scatter",  name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x", yaxis: "y2" },';
                             ...
                             //       datosgrafVertical_DMEA_Aux = '{ x: [' + matriz[j].valor.replace('"', '') + '], y: [' + datosProfundidad + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x2", yaxis: "y"}';
                                ...
                                case 'MFIA':
                                    // Aqui se arma la trama de la grafica Horizontal (tiempo)-------------------
                                    datosgrafHorizont_MFIA_Aux = '{ x: [' + datosDateTime + '], y: [' + matriz[j].valor.replace('"', '') + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x", yaxis: "y3" },';
                           ...
                           //         datosgrafVertical_MFIA_Aux = '{ x: [' + matriz[j].valor.replace('"', '') + '], y: [' + datosProfundidad + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x3", yaxis: "y"}';
                                ...
                                case 'RPM':
                                    // Aqui se arma la trama de la grafica Horizontal (tiempo)-------------------
                                    datosgrafHorizont_RPM_Aux = '{ x: [' + datosDateTime + '], y: [' + matriz[j].valor.replace('"', '') + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x", yaxis: "y4" },';
                           ...
                           //         datosgrafVertical_RPM_Aux = '{ x: [' + matriz[j].valor.replace('"', '') + '], y: [' + datosProfundidad + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x4", yaxis: "y"}';
                                ...
                                case 'TQA':
                                    // Aqui se arma la trama de la grafica Horizontal (tiempo)-------------------
                                    datosgrafHorizont_TQA_Aux = '{ x: [' + datosDateTime + '], y: [' + matriz[j].valor.replace('"', '') + '], mode: "lines+markers",  type: "scatter", name: "' + matriz[j].clave.replace('_', ' ') + '",  text: "' + matriz[j].clave.replace('_', ' ') + '", xaxis: "x", yaxis: "y5" },';
                    ...
                    var vector_H_DBTM = '{' + datosgrafHorizont_DBTM_Aux.substring(datosgrafHorizont_DBTM_Aux.length - 1, 1);

                    var vector_H_DMEA = '{' + datosgrafHorizont_DMEA_Aux.substring(datosgrafHorizont_DMEA_Aux.length - 1, 1);

                    var vector_H_MFIA = '{' + datosgrafHorizont_MFIA_Aux.substring(datosgrafHorizont_MFIA_Aux.length - 1, 1);

                    var vector_H_RPM = '{' + datosgrafHorizont_RPM_Aux.substring(datosgrafHorizont_RPM_Aux.length - 1, 1);

                    var vector_H_TQA = '{' + datosgrafHorizont_TQA_Aux.substring(datosgrafHorizont_TQA_Aux.length - 1, 1) ;
                     


                        fetch(urlAuxilir1 + '?id=' + idinicial)
                            .then(res => res.json())
                            .then(
                                (result2) => {
                                    this.setState({
                                    ...
                                    for (let k = 0; k < datosregistro2.length; k++) {
                                        ...
                                        fec1 = fec1.replace('.000Z', ''); fec1 = fec1.replace('T', ' '); 
                                        fec2 = fec2.replace('.000Z', ''); fec2 = fec2.replace('T', ' '); 
                                        datosfecIni_Eve_Aux = datosfecIni_Eve_Aux + ',' + '\'' + fec1 + '\'';
                                        datosfecFin_Eve_Aux = datosfecFin_Eve_Aux + ',' + '\'' + fec2 + '\'';
                                        ...
                                        datosproFin_Eve_Aux = datosproFin_Eve_Aux + '\'' + pro2 + '\'' + ',';
                                         
                                        datosdescrp_Eve_Aux = datosdescrp_Eve_Aux+ '\'' + datosregistro2[k].descripcion + '\'' + ',';      
                                    }

                                    datosfecIni_Eve_Aux = datosfecIni_Eve_Aux.substring(1, datosfecIni_Eve_Aux.length );
                                    datosfecFin_Eve_Aux = datosfecFin_Eve_Aux.substring(1, datosfecFin_Eve_Aux.length);
                                    datosproIni_Eve_Aux = datosproIni_Eve_Aux.substring(datosproIni_Eve_Aux.length - 1, 1);
                                    datosproFin_Eve_Aux = datosproFin_Eve_Aux.substring(datosproFin_Eve_Aux.length - 1, 1);
                        ...
                        var vectorPrincipal = '{' + datosGraficaPrincipal_Aux.substring(datosGraficaPrincipal_Aux.length - 1, 1)   ;
    ...
    render() {
        const { datosGraficaEventos_Auxiliar, wells_id, dataWells, datosParaGraficaPrincipal, datosgrafVertical_DMEA, datosgrafVertical_MFIA, datosgrafVertical_RPM, datosgrafVertical_TQA, datosgrafVertical_DBTM,datosgrafHorizont_DMEA, datosgrafHorizont_MFIA, datosgrafHorizont_RPM, datosgrafHorizont_TQA,datosgrafHorizont_DBTM} = this.state;
        ...
        var layout_Horizontal = {
            ...
            yaxis1: { title: 'DBTM', autorange: 'reversed', titlefont: { size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
            yaxis2: { title: 'DMEA', titlefont: { size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
            yaxis3: { title: 'MFIA', titlefont: { size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
            yaxis4: { title: 'RPM', titlefont: { size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
            yaxis5: { title: 'TQA', titlefont: { size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
        };
        ...
        var layout_Vertical = {
           ...
           // height: 700,
            ...
            plot_bgcolor: 'white',
            paper_bgcolor: 'lightgray', 
            grid: { rows: 1, columns: 5, subplots: ['x1y', 'x2y', 'x3y', 'x4y', 'x5y'], roworder: 'left to right' },
            yaxis: {fixedrange: false, autorange: 'reversed', title: 'Profundidad', nticks: 5,},
            images: [{ "source": "fondo.jpg", "xref": "x", "yref": "y", "x": 0, "y": 0, "sizex": 1, "sizey": 12114, "sizing": "stretch", "opacity": 1.0, "layer": "below" },], 
            xaxis1: { fixedrange: false, textposition: 'top center', side: 'top', title: 'DBTM', titlefont: {size: 10,color: 'blue',}, tickfont: { size: 8.0 },},
            xaxis2: { fixedrange: false, textposition: 'top center', side: 'top', title: 'DMEA', titlefont: {size: 10,color: 'blue',}, tickfont: { size: 8.0 },},
            xaxis3: { fixedrange: false, textposition: 'top center', side: 'top', title: 'MFIA', titlefont: {size: 10,color: 'blue',}, tickfont: { size: 8.0 },},
            xaxis4: { fixedrange: false, textposition: 'top center', side: 'top', title: 'RPM', titlefont:  {size: 10,color: 'blue',}, tickfont: { size: 8.0 },},
            xaxis5: { fixedrange: false, textposition: 'top center', side: 'top', title: 'TQA', titlefont:  {size: 10, color: 'blue', }, tickfont: { size: 8.0 }, },
        ...
        var dataPrincipal_1 = eval("[" + this.state.datosParaGraficaPrincipal + "]"); 
        var dataPrincipal_2 = eval("[" + this.state.datosGraficaEventos_Auxiliar + "]"); 
   ...
   //     var data_Hor_RPM = eval("[" + this.state.datosgrafHorizont_RPM + "]");
       ...
       // console.log(data_Ver_DBTM);
        ...
        Plotly.react('graphDiv', dataPrincipal_01, layout_Principal, config_general);
        ...
        return (
            <div className="App">
                ...
                <div>
                    ...
                    <select name="wells_id" id="wells_id" className="form-control" value={this.state.selectValue}
