...
class viewVisualConfigEdi extends Component {
  ...
  peticionPut = () => {
    axios.put(URL + 'template_config', this.state.form1).then(response => {
  ...
  handleChange21 = async e => {
    ...
    this.state.form1.pkuser = JSON.parse(
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        >
          <h5>
            Actualizaci&oacute;n parametrizaci&oacute;n de la
            visualizaci&oacute;n de la gr&aacute;fica principal
          </h5>
          <hr></hr>
          <h6>
            <iconList.Add /> 1: Definici&oacute;n del Pozo y fuente de origen de
            datos
          </h6>
          <hr></hr>
        </div>
        ...
        >
          ...
          <select
            ...
            className="form-control"
            value={form1 ? form1.archivo_encabezado_id : ''}
        ...
        <div
          style={{ float: 'left', padding: '15px 0 0 30px' }}
        ...
        <div
          style={{ float: 'left', padding: '05px 0 0 150px' }}
          className="form-group col-8"
        >
          <hr></hr>
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
