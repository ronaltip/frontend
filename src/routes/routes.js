...
import Cavings from '../views/Cavings';
import ArchivoLas from '../views/ArchivoLas';
import Fels from '../views/Fels';
    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route
            exact
            path="/homologacion_archivos"
            component={viewHomologacionArchivos}
          />
          ...
          <Route
            exact
            path="/visual_config_lista"
            component={viewVisualConfigLista}
          />
          <Route
            exact
            path="/visual_config_track"
            component={viewVisualConfigTrack}
          />
          <Route exact path="/visual_config" component={viewVisualConfig} />

          <Route
            exact
            path="/visual_historicos"
            component={viewVisualHistorico}
          />
          <Route
            exact
            path="/visual_historicos_dp:id"
            component={viewVisualHistoricoDP}
          />
          <Route
            exact
            path="/visual_historicos_dc/:id"
            component={viewVisualHistoricoDPC}
          />
          ...
          <Route
            exact
            path="/wits_homologacion"
            component={viewWitsHomologacion}
          />
